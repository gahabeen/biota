...
const function_1 = require("./functions/helpers/function");
...
const logData = {
    owner: () => merge({ owned_by: faunadb_1.query.Var('ref'), owner_changed_at: faunadb_1.query.Now(), owner_changed_by: faunadb_1.query.Identity() }),
    credentials: () => merge({ credentials_changed_by: faunadb_1.query.Var('ref'), credentials_changed_at: faunadb_1.query.Now() }, {}),
    assign: () => merge({ assigned_to: faunadb_1.query.Var('ref'), assigned_at: faunadb_1.query.Now() }),
