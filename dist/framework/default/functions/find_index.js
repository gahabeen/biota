...
exports.FindIndex = udfunction_1.UDFunction({
    ...
    body: faunadb_1.query.Query(faunadb_1.query.Lambda(["resource", "terms_fields"], faunadb_1.query.Let({
        indexes: faunadb_1.query.Paginate(faunadb_1.query.Intersection(faunadb_1.query.Match(faunadb_1.query.Index(index_1.IndexName("indexes__by__resource")), [
            faunadb_1.query.Var("resource")
        ]), faunadb_1.query.Union(faunadb_1.query.Map(faunadb_1.query.Var("terms_fields"), faunadb_1.query.Lambda(["field"], faunadb_1.query.Match(faunadb_1.query.Index(index_1.IndexName("indexes__by__terms")), [
