...
export const repsert: DBFactoryFQLUDFRepsert = {
  document(collection, id, data = {}) {
    return q.If(
      ...
      q.Call(udfName('ReplaceDocument'), Identity(), q.Var('private_key'), collection, id, data),
  ...
  database(name, options = {}) {
    return q.If(
      ...
      q.Call(udfName('ReplaceDabase'), Identity(), q.Var('private_key'), name, options),
  ...
  collection(name, options = {}) {
    return q.If(
      ...
      q.Call(udfName('ReplaceCollection'), Identity(), q.Var('private_key'), name, options),
  ...
  index(name, options = {}) {
    return q.If(
      ...
      q.Call(udfName('ReplaceIndex'), Identity(), q.Var('private_key'), name, options),
  ...
  udfunction(name, options = {}) {
    return q.If(
      ...
      q.Call(udfName('ReplaceUDFunction'), Identity(), q.Var('private_key'), name, options),
  ...
  role(name, options = {}) {
    return q.If(
      ...
      q.Call(udfName('ReplaceRole'), Identity(), q.Var('private_key'), name, options),
  ...
  token(ref, options = {}) {
    return q.Let(
      ...
      q.If(
        q.IsRef(q.Var('doc')),
        q.Call(udfName('ReplaceToken'), Identity(), q.Var('private_key'), q.Var('doc'), options),
