          ...
          q.Let(
            {
              ...
              action: action(ctx)('login', q.Var('user')).log(),
            },
            q.Var('session'),
          ),
              ...
              q.Let(
                {
                  ...
                  action: action(ctx)('logout_everywhere', q.Var('user')).log(),
                },
                q.Var('logging_out'),
              ),
              q.Let(
                {
                  ...
                  action: action(ctx)('logout', q.Var('user')).log(),
                },
                q.Var('logging_out'),
              ),
            ),
          ...
          q.Let(
            {
              ...
              session: userSession(ctx)().start(q.Var('user'), null), // #improve: add expirationDuration
              action: action(ctx)('register', q.Var('user')).log(),
            },
            q.Var('session'),
          ),
