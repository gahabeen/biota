      ...
      q.Let(
        {
              ...
              q.If(
                ...
                q.If(
                  ...
                  [
                    ...
                    q.LowerCase(
                      q.ToString(q.Select("$ngram", q.Var("value"), ""))
                    ),
          ...
          validTermIndexes: q.Filter(
            q.Var("termIndexes"),
            q.Lambda(["index", "value", "field"], q.IsIndex(q.Var("index")))
          ),
          unvalidIndexes: q.Filter(
            q.Var("termIndexes"),
            q.Lambda(
              ["index", "value", "field"],
              q.Not(q.IsIndex(q.Var("index")))
            )
          ),
          unvalidFields: q.Concat(
            q.Map(
              q.Var("unvalidIndexes"),
              q.Lambda(["index", "value", "field"], q.Var("field"))
            ),
            ", "
          )
        },
